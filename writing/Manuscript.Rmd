...
While the influence of dispersal and changing abiotic conditions, including temperature, can be easily assessed through experimental manipulation [e.g., @symons2013; @limberger2019], experimentally assessing the role of biotic interactions is more challenging. In microcosms, the role of biotic interactions in shaping environmental responses has been experimentally assessed by comparing the response of species to environmental change in monoculture vs. mixture [@davis1998; @thompson2021]. Unfortunately, because each species requires its own set of replicate experimental units [e.g., 216 microcosms in @thompson2021], scaling this approach up to larger scales such as mesocosms is prohibitive. Without being able to experimentally manipulate species interactions, an alternative is to control abiotic conditions and dispersal and then use statistical models to assess if there community dynamics that cannot be explained by these factors. This includes positive or negative species co-occurrence patterns that are not related to environmental differences as well as temporal shifts in community composition that are not explained by changes in abiotic conditions [@ovaskainen2020].
